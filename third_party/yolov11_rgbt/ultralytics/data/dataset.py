...
class YOLODataset(BaseDataset):
    ...
    def get_labels(self):
        ...
        use_simotm = getattr(self, 'use_simotm', None)
        kind_label = getattr(self, 'kind_label', None)
        if use_simotm is None and hasattr(self, 'data'):
            use_simotm = self.data.get("use_simotm", None)
            
        self.label_files = img2label_paths(self.im_files, use_simotm=use_simotm, kind_label=kind_label)
